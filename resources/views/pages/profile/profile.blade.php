                  ...
                  <div class="active tab-pane" id="settings">
                    <form action="update-profile" method="post" class="form-horizontal" id="frmProfile">
                        ...
                        <div class="form-group row" hidden>
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="id" id="idUser" value="{{$data['0']['id']}}" placeholder="Name" readonly>
                            </div>
                          </div>
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Name</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="name" id="inputName" value="{{$data['0']['name']}}" placeholder="Name" readonly>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" name="email" id="inputEmail" value="{{$data['0']['email']}}" placeholder="Email" readonly>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="level" id="level" value="{{$data['0']['level']}}" placeholder="Level" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="password" class="col-sm-2 col-form-label">Password</label>
                        <div class="col-sm-10">
                          <input type="password" class="form-control" name="password" id="password" value="{{$data['0']['password']}}" placeholder="Password" readonly>
                        </div>
