        ...
        <div class="card">
          <div class="card-header">
            @if (!isset($isSoftDelete))
              <a class="btn btn-success" href="{{ route('item.create') }}"><i class="fas fa-plus"></i> Add</a>
              <a class="btn btn-default" href="{{ route('item.showSoftDelete') }}"><i class="fas fa-plus"></i> View Item Deleted</a>
            @endif
              ...
              <tbody>
                @foreach($data as $items)
                  <tr>
                      ...
                      <td>
                        @if (!isset($isSoftDelete)) 
                        <a href="{{ route('item.edit', [$items->id]) }}" class="btn btn-success"><i class="fas fa-edit"></i></a> || 
      ...
      success += 
        '<div class="card-header p-2"> \
          <div class="alert alert-primary alert-dismissible fade show" role="alert">\
            ...
            <strong>Notify!</strong> Delete Item successfully!\
          </div>\
        </div>';
      ...
      success += 
        '<div class="card-header p-2"> \
          <div class="alert alert-primary alert-dismissible fade show" role="alert">\
            ...
            <strong>Notify!!</strong> Item recovery successful!\
          </div>\
        </div>';
